        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-2.5">
            ...
            <button
              ...
              className="p-2.5 rounded-xl bg-[#8C3A27] text-white hover:bg-red-700 transition-all cursor-pointer shadow-md flex items-center justify-center shrink-0 active:scale-95"
              title="Đăng Xuất"
            >
