...
export default function ChefProfilePage() {
  ...
  const [fullName, setFullName] = useState(user?.fullName || 'Bếp Trưởng Alex');
  const [phone, setPhone] = useState(user?.phone || '+84 901234568');
  ...
  const handleEmailChangeAttempt = (e) => {
    ...
    setEmail(val);
    if (val !== (user?.email || 'chef@restaurant.com')) {
  ...
  const handleUpdateProfile = async (e) => {
    ...
    try {
      ...
      setInfoMessage('Cập nhật thông tin Hồ Sơ Bếp Trưởng thành công!');
    } catch (err) {
      console.error(err);
      setErrorMessage(err.response?.data?.message || 'Cập nhật hồ sơ thất bại.');
    }
  };
  ...
  return (
    <div className="min-h-screen bg-[#FAF7F2] text-[#3A1C14] font-sans">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="bg-white p-6 rounded-3xl border border-[#3A1C14]/10 shadow-md flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <span className="text-xs text-gray-500 font-mono">
                ROLE_CHEF (Chuyên Viên Chế Biến / Bếp Trưởng) • {gender === 'MALE' ? 'Nam' : gender === 'FEMALE' ? 'Nữ' : 'Khác'}
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-white p-6 rounded-3xl border border-[#3A1C14]/10 shadow-xl space-y-5">
            ...
            <form onSubmit={handleUpdateProfile} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-4 py-2.5 text-xs rounded-xl bg-[#FAF7F2] border border-gray-200 focus:outline-none focus:border-[#D97706]"
                  />
                </div>
                {emailWarning && (
              ...
              <div>
                <label className="text-xs font-bold text-gray-600 block mb-1">Họ & Tên Bếp Trưởng *</label>
                <div className="relative">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <select
                    ...
                    className="w-full pl-9 pr-4 py-2.5 text-xs rounded-xl bg-[#FAF7F2] border border-gray-200 focus:outline-none focus:border-[#D97706] cursor-pointer"
                  >
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-2xl bg-[#3A1C14] text-white text-xs font-bold hover:bg-[#5a2c20] transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
              >
          ...
          <div className="bg-white p-6 rounded-3xl border border-[#3A1C14]/10 shadow-xl space-y-5">
            <h3 className="font-bold font-serif text-lg text-[#3A1C14] flex items-center gap-2 border-b border-gray-100 pb-3">
              <Lock className="w-5 h-5 text-[#D97706]" /> Đổi Mật Khẩu Bếp Trưởng
            </h3>
            ...
            <form onSubmit={handleChangePassword} className="space-y-4">
              ...
              <button
                type="submit"
                className="w-full py-3 rounded-2xl bg-[#D97706] text-white text-xs font-bold hover:bg-[#b45d03] transition-all shadow-md flex items-center justify-center gap-2 cursor-pointer"
              >
                Cập Nhật Mật Khẩu
              </button>
            </form>
