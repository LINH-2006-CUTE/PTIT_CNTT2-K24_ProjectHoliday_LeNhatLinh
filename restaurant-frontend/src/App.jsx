...
const DashboardRoute = () => {
  ...
  if (user && (user.roles.includes('ROLE_CHEF') || user.roles.includes('ROLE_STAFF'))) {
      ...
      <AuthProvider>
        <CartProvider>
          ...
          <Routes>
            ...
            {/* Protected Customer, Chef, Cashier & Admin Routes */}
            <Route element={<PrivateRoute />}>
              ...
              <Route path="/chef/inventory" element={<ChefInventoryPage />} />
              ...
              {/* REDIRECT ALL UNUSED WAITER & MANAGER ROUTES TO ADMIN */}
