...
public class PaymentServiceImpl implements PaymentService {
    ...
    public InvoiceDTO processPayment(PaymentRequest request) {
        ...
        // Prices in menu are all-inclusive
        ...
        // Send payment notification to Cashier for confirmation
        try {
            ...
            staffNotificationRepository.save(StaffNotification.builder()
                    ...
                    .title("💳 YÊU CẦU XÁC NHẬN THANH TOÁN #ORD-" + order.getId())
                    .message("Khách hàng " + cName + " vừa gửi thanh toán (" + request.getPaymentMethod() + ") đơn món #ORD-" + order.getId() + " (" + tName + "). Thu ngân vui lòng tiếp nhận & xác nhận để chuyển đơn xuống Bếp!")
                    .urgent(true)
                    .isRead(false)
                    .isConfirmed(false)
            ...
            // ignore exception for notifications
        }
